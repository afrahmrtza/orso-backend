...
<div class="sidebar text-center">
    ...
    <div class="nav flex-column nav-pills">
        <button class="nav-link active" data-bs-toggle="pill" data-bs-target="#tab-laporan" onclick="loadLaporan()">📊 Dashboard</button>
        ...
        <a href="logout.php" class="nav-link text-danger mt-5 text-decoration-none" onclick="return confirm('Yakin ingin keluar?')">🚪 Logout</a>
    </div>
</div>
...
// Header menggunakan role dari session agar sinkron dengan API jika diperlukan
