...
<div class="sidebar text-center">
    ...
    <div class="nav flex-column nav-pills">
        <a href="/dashboard/summary" class="nav-link active">
            📊 Dashboard
        </a>

        <a href="/manage/pesanan" class="nav-link">
            🛒 Pesanan
        </a>

        <a href="/manage/menu" class="nav-link">
            ☕ Menu
        </a>
        ...
        <a href="/manage/testimoni" class="nav-link">
            💬 Ulasan
        </a>

        <a href="/report/penjualan" class="nav-link">
            📜 Laporan
        </a>

        <a href="/logout" class="nav-link text-danger mt-5 text-decoration-none">
            🚪 Logout
        </a>
